...
def list_please() -> list:
    ...
    list = ["books", "fantasy", "genres", "escapism"]
    return list
...
def string_list_please() -> list:
    ...
    list_string = ["books", "fantasy", "genres", "escapism", "movies", "late nights"]
    return list_string


def dictionary_please() -> dict:
    """Returns a dictionary, anything you like."""
    first_dictionary_ever = {"facts":"truth", "books": "freedom"}
    return first_dictionary_ever
